...
const CGV = () => (
  <div className="min-h-screen bg-background text-foreground">
    <Helmet>
      <title>Conditions Générales de Vente — ASC&D</title>
      <meta name="description" content="CGV de ASC&D (Angelot Stranieri Consulting & Development) — conditions de vente, paiement, livraison et résiliation pour nos prestations web." />
      <link rel="canonical" href="https://ascnd.fr/cgv" />
    </Helmet>
    <div className="max-w-3xl mx-auto px-4 py-16">
      ...
      <div className="prose prose-invert prose-sm max-w-none space-y-6 text-muted-foreground [&_h2]:text-foreground [&_h2]:font-display [&_h2]:font-bold [&_h2]:text-lg [&_h2]:mt-8 [&_h2]:mb-3 [&_strong]:text-foreground">
        ...
        <p>
          ...
          <strong> ASC&D — Angelot Stranieri Consulting & Development</strong>, micro-entreprise, et tout client (ci-après « le Client »)
        ...
        <p>Le paiement s'effectue selon les modalités définies dans le devis :</p>
        ...
        <p>
          ...
          ASC&D se réserve le droit de mentionner la réalisation dans son portfolio,
        ...
        <p>
          ASC&D s'engage à mettre en œuvre tous les moyens nécessaires à la bonne
        ...
        <p>
          ...
          des tribunaux du ressort du siège social d'ASC&D.
        </p>
